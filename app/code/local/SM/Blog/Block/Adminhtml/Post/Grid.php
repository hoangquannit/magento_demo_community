...
class SM_Blog_Block_Adminhtml_Post_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
  public function __construct()
  {
    ...
    {
        $collection = Mage::getModel('sm_blog/post')->getCollection()
  ...
  protected function _prepareColumns()
  {
      ...
      $this->addColumn('created_at', array(
          'header'    => Mage::helper('blog')->__('Create date'),
          'align'     =>'left',
          'index'     => 'created_at',
      ));

      $this->addColumn('updated_at', array(
          'header'    => Mage::helper('blog')->__('Update date '),
          'align'     =>'left',
          'index'     => 'updated_at',
      ));
